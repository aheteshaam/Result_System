...
public class InsertNewResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("All sudent results");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/srm","root","Ahetesham@1");
         Statement st = con.createStatement();
         ResultSet rs =st.executeQuery("sele * from student where rollNO = '"+rollNo+"'");
         if(rs.next()){
             st.executeUpdate("insert into result(rollNo,phy,che,math,electrical,electronics)value('"+rollNo+",' "+phy+",' "+che+",' "+math+",' "+electronic+",' "+electrical+",')");
         }
